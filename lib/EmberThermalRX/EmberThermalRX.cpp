...
void EmberThermalRX::update() {
  ...
  if (shouldDraw) {
    ...
    Serial.print("[RX] F#"); Serial.print(framesDrawn);
    Serial.print(" "); Serial.print(packetsGot);
    Serial.print("/32 draw="); Serial.print(drawTime);
    Serial.print("ms dt="); Serial.print(dt);
    Serial.print("ms ~"); Serial.print(dt > 0 ? 1000 / dt : 0);
