...
## Atenção!
Esta branch "antigos" serve para salvar as primeiras versões do projeto, nada daqui é final ou deve ser usado em caso de recriação.

A versão mais recente estão nas branches do [drone](https://github.com/Jaquetaa/Ember/tree/drone) e do [comando](https://github.com/Jaquetaa/Ember/tree/comando).
